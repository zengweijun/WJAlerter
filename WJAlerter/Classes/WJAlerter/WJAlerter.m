...
- (void)_show {
    ...
    UIViewController *presentVc = [UIApplication sharedApplication].delegate.window.rootViewController;
    [presentVc presentViewController:alertVc animated:YES completion:NULL];
}
